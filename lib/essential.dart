...
class CurvePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    var paint = Paint();
    paint.color = HexColor("0049f0");
    paint.style = PaintingStyle.fill;

    var path = Path();

    path.moveTo(0, size.height * (0.9167 - 0.6));
    path.quadraticBezierTo(size.width * 0.25, size.height * (0.875 - 0.6),
        size.width * 0.5, size.height * (0.9167 - 0.6));
    path.quadraticBezierTo(size.width * 0.75, size.height * (0.9584 - 0.6),
        size.width * 1.0, size.height * (0.9167 - 0.6));
